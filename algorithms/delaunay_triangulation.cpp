    ...
    {}
        ...
        if((!isPointOnEdge1) && (!isPointOnEdge2) && (!isPointOnEdge3))
        {
            ...
            for (size_t t = 0;t<3;t++) {
                ...
                Triangulation_member new1 = Triangulation_member(new_triangles[t],adjList,current_node->appendChild(new_triangles_indexes[t]));
            ...
            Triangle2d current_new3 = Triangle2d(point,other_triangle.getPoint(currentIndexInOtherTriangle),other_triangle.getPoint((currentIndexInOtherTriangle+2)%3));
